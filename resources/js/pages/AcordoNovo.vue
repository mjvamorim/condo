    ...
    <v-tabs-items v-model="tab">
      ...
      <v-tab-item>
        <v-card flat>
          <v-card-text>
            ...
            >
              ...
              <template #item.valorpago="{ item }">
                <div class="text-right">
                  {{ item.valorpago ? "R$" + item.valorpago.toFixed(2) : "" }}
                </div>
              </template>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="danger" outlined text @click="tab = 0"
              >Anterior</v-btn
            >
            <v-btn
              color="primary"
      ...
      <v-tab-item>
        <v-card flat>
            ...
            <v-container style="max-width: 800px">
              <v-row>
                <v-col style="max-width: 30%">
                  ...
                  <v-btn color="primary" outlined text @click="gerarParcelas()"
                    >Gerar Parcelas</v-btn
                  >
                </v-col>
                <v-col style="padding-left: 25px">
                  ...
                  <v-container>
                    <v-btn color="danger" outlined text @click="totaliza()"
                      >Totaliza</v-btn
                    >
                    <v-flex xs-12>
                      <h6>
                        Total Devido : R$
                        {{ totDebitos ? totDebitos.toFixed(2) : "0.00" }}
                      </h6>
                    </v-flex>
                    ...
                    <v-flex xs-12>
                      <h6>
                        Total Acordo: R$
                        {{ totPrestacoes ? totPrestacoes.toFixed(2) : "0.00" }}
                      </h6>
                    </v-flex>
                  </v-container>
                </v-col>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="danger" outlined text @click="tab = 1"
              >Anterior</v-btn
            >
            <v-btn color="primary" outlined text @click="gerarAcordo()"
              >Gerar Acordo</v-btn
            >
          </v-card-actions>
        </v-card>
