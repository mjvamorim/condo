    ...
    <v-card-text>
      <p> Para geração dos boletos são necessários os seguintes passos:</p>
        ...
        <ul>
          ...
          <li>Imprimir ou enviar os boletos por email "Cadastros->Debitos" (vide manual)</li>
        </ul>
      </ul>
      <p>O <a href='manual'>manual do usuário</a> detalha cada um dos procedimentos acima citados</p>
      <br/>
      <p>Para facilitar a utilização do Sistema eCondominio, a Pegasus Sistemas fornece uma 
        <a href='planilha'>planilha </a> onde você pode preencher os dados dos 
        proprietários/apartamentos e enviar os dados para importação automatica do sistema. 
        Após preenchida a planilha deve ser enviada para systems.pegasus@gmail.com.
      </p>
    </v-card-text>
  </v-card>
</template>
