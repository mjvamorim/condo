...
class Debito extends BaseModelTenant
{
    ...
    public function unidade() { return $this->belongsTo('App\Models\Unidade','unidade_id'); }
    public function taxa() { return $this->belongsTo('App\Models\Taxa','taxa_id'); }
    public function acordo() { return $this->belongsTo('App\Models\Acordo','acordo_id'); }
    public function acordo_quitacao() { return $this->belongsTo('App\Models\Acordo','acordo_quitacao_id'); }
    ...
    public function getTemDebitosAnterioresAttribute() {
        ...
        $temDebitosAnteriores = $debitos!==null;
        return $temDebitosAnteriores;
     }
    ...
    public function getTemAcordosVencerAttribute() {
        ...
        $clausulaWhere[] = ['dtpagto', NULL];
        $debitos = Debito::where($clausulaWhere)->first();
        $temAcordosVencer = $debitos!==null;
        return $temAcordosVencer;
     }
